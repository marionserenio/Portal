	...
	<div id="CampaignContainer">
			...
			<div id="FFG-ErrorContainer">
				...
				<div id="FFG-Campaign-Questions">
					...
					<input id="FFG-Working" name="FFG-Working" type="text" data-bind="value: Working">
					...
					<input type="text" id="FFG-AgeGroup" name="FFG-AgeGroup"  data-bind="value: AgeGroup">
					...
					<input type="text" id="FFG-YearlyIncome" name="FFG-YearlyIncome" data-bind="value: IncomeGroup">
			
					</input>

					<p><strong>Email</strong></p>
					<input class="span3" id="FFG-Email" name="FFG-Email" autocomplete="off" data-bind="value: Email"></input> <br>

					<p><strong>Date of appointment</strong></p>
					<input class="span3" id="FFG-DateAppointment" name="FFG-DateAppointment" autocomplete="off" data-bind="value: DAppointment"></input> <br>
					

					<p><strong>Time of appointment</strong></p>
					<input class="span3" id="FFG-TimeAppointment" name="FFG-TimeAppointment" autocomplete="off" data-bind="value: TAppointment"></input> <br>

					<p><strong>Comments</strong></p>
					<textarea id="FFG-Comments" name="FFG-Comments" autocomplete="off" data-bind="value: Comments"></textarea> <br>



					<button class="button btn" disabled="disabled" id="SaveFFGbutton">Disabled</button>
				</form>
